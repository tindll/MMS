...
subprocess.run(["docker", "cp","test3.py","intelligent_goldberg:/testingTF/test3.py"])
...
subprocess.run(["docker", "exec","-it","intelligent_goldberg", "python3","testingTF/test3.py"])
subprocess.run(["docker", "cp","intelligent_goldberg:/testingTF/plotm1.png","."])
subprocess.run(["docker", "cp","intelligent_goldberg:/testingTF/model2.png","."])
